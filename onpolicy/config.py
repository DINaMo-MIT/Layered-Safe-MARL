...
def get_config():
    ...
    parser.add_argument("--zeroshift", type=int,
                        default=3, help="zero shift for relu, tanh etc")
    ...
    parser.add_argument("--num_landmarks", type=int, default=0, help="Number of landmarks PER AGENT. Default is 0, in which case, the number of landmark is set automatically by the specific scenario in eval_mpe.")
    ...
    parser.add_argument("--horizon", type=int,
                        default=1, help="horizon for the motion primitives")

    ## death masking update
    parser.add_argument("--use_masking", type=lambda x:bool(strtobool(x)), default=False,
                        help="use masking for action space")
    ...
    parser.add_argument("--checkpoint_interval", type=int, default=0,
                        help="episode interval to checkpoint model, if set to 0, no separate checkpoint.")
