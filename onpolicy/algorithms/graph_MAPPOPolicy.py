...
from onpolicy.algorithms.graph_actor_critic import GR_Actor, GR_Critic, GR_Latent_Dynamics
...
class GR_MAPPOPolicy:
    ...
    def get_actions(self, 
        ...
        # print("rnn", rnn_states_actor)
        # print("masks", masks)
        # print("available_actions", available_actions)
        actions, action_log_probs, rnn_states_actor, _ = self.actor.forward(obs,
                                                            node_obs,
                                                            adj,
                                                            agent_id,
                                                            rnn_states_actor,
    ...
    def act(self, 
        ...
        """
            ...
            deterministic: (bool) 
                ...
                distribution or should be sampled.
        """
        actions, actions_log_prob, rnn_states_actor, actor_features = self.actor.forward(obs,
                                                        node_obs,
                                                        adj,
                                                        agent_id,
                                                        rnn_states_actor, 
        ...
        return actions, rnn_states_actor, actor_features, actions_log_prob